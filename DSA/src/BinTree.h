...
struct BinNode {
    ...
    BinNode(const T& d, BinNode<T>* p = NULL, BinNode<T>* l = NULL, BinNode<T>* r = NULL)
...
public:
    ...
    BinNode<T>* insertAsLC(const T& e, BinNode<T>* x);
    BinNode<T>* insertAsRC(const T& e, BinNode<T>* x);
